...
# Name: cfdistro.spec 
#-------------------------------------------------------------------------------
# $Id: cfdistro.spec,v 1.1 $
#-------------------------------------------------------------------------------
# Purpose: RPM Spec file for cfdistro
# Version 3.33
#===============================================================================
# No debuginfo:
...
%define summary   that awesome cfdistro app you never heard about
%define version   ${distro.version}
%define release   Base
%define license   All Rights Reversed
%define group     Applications/System
%define _topdir  %(echo $PWD)
%define _tmppath  /tmp
%define source    release.tar.gz
%define url       http://google.com
%define vendor    denstar
%define packager  Denny Valliant 
