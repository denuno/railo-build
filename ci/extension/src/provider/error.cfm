...
<cfset doOpen = cfecall.doOpen("2341","/Users/denny/programs/eclipse-inst/eclipse35.command",url.cfe)>
<cfabort />
...
<script language="JavaScript">
	...
	function openInEditor(file,line) {
		...
		var url=<cfoutput>"#getContextRoot()#/railo-context/error.cfm?cfe="</cfoutput> + file + '|' + line;
...
<tr>
	...
	/workspace/denstar/src/cfantrunner/build/template/build.xml:53
